...
public class CodeGenVisitor implements SimpleVisitor {
    ...
    private final List<Function> functions = VtableGenerator.functions;
    private final List<ClassDecaf> classes = VtableGenerator.classes;
    private final HashMap<String, String> stringLiterals = new HashMap<>();
    ...
    private final int tempfRegsNumber = 0;
    ...
    private void visitReadLine(ASTNode node) {
        ...
        SymbolInfo si = new SymbolInfo(node, PrimitiveType.STRING);
    ...
    private void visitContinueNode() throws Exception {
